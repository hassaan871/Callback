  ...
  return (
    <header className="sticky top-0 z-[100] bg-bg/82 backdrop-blur-[10px] border-b border-border-soft">
      <div className="max-w-maxw mx-auto px-8 py-4 flex items-center justify-between gap-6 md:px-8 px-5">
        <a href="#top" className="flex items-center gap-2 font-display font-semibold text-[1.1rem]">
        ...
        <div className="flex items-center gap-3">
          <a href="#pricing" className="btn btn-ghost hidden sm:inline-flex px-5 py-2.5 rounded-sm border border-border text-text hover:border-teal hover:text-teal font-semibold text-[0.92rem] transition-all duration-150 hover:-translate-y-[1px]">Log in</a>
