...
/**
 * Login screen component providing user authentication inputs
  ...
  return (
    <div className="min-h-screen bg-bg text-text font-sans flex items-center justify-center py-12 px-5 relative overflow-hidden">
      ...
      <div className="w-full max-w-[440px] bg-bg-elevated border border-border rounded-DEFAULT p-8 md:p-10 shadow-[0_30px_60px_-30px_rgba(0,0,0,0.6)] z-10">
          ...
          <h1 className="text-[1.8rem] leading-tight font-display mb-2">Log in to Callback</h1>
          <p className="text-text-muted text-[0.92rem] mb-6">Pick up your tracks and progress right where you left off.</p>
          ...
          <p className="text-[0.88rem] text-text-muted text-center mt-6">
            Don't have an account? <Link to="/signup" className="text-accent hover:underline">Sign up free</Link>
          </p>
